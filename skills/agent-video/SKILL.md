...
9. Check subtitle timing against audio at the first spoken line, one middle joke line, and the final punchline.
10. Visually check start, middle, and end frames before saying the video is ready.
11. If any rule fails, fix it before handoff or report the exact blocker.
...
6. Verification
   ...
   - Check subtitle timing against audio before export. Watch at least the first spoken subtitle, one middle joke subtitle, and the final punchline. If captions visibly lead or lag the audio, retime and re-check.
...
- Subtitle/audio timing is a pre-export hard gate. Styling can be correct and the video still fails if captions lead or lag the speaker.
- Do not hand off a video until start, middle, and final-punchline timing have been checked after the last subtitle edit.
...
- Confirm subtitle timing was checked against audio at the start, middle, and final punchline.
...
- Subtitle timing: start/middle/punchline checked or issue noted
