...
$lines.Add("& `$env:USERPROFILE\.codex\scripts\codex-doctor.cmd")
$lines.Add("& `$env:USERPROFILE\.codex\scripts\codex-gear-test.cmd")
$lines.Add("& `$env:USERPROFILE\.codex\scripts\codex-systems-status.cmd")
$lines.Add('```')
$lines.Add("")
...
$lines.Add("Run codex-doctor before continuing.")
